...
<head>
    ...
    <script src="<?= base_url() ?>assets/js/plugins/datatable/ColReorder.min.js"></script>
    ...
    <style>
    .tile {background-color:#eff0f2;border-radius:6px;padding:14px;text-align:center;}
    .tile-image {margin:31px 0 27px;vertical-align:bottom;}
    .tile-image .big-illustration {height:111px;margin-top:20px;width:112px;}
    .tile-title {font-size:20px;margin:0;}
    .jumbotron {marign:60px 0;text-align:center;}
